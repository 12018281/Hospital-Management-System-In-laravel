                    ...
                    <div class="header-info">
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a
                                    href="tel:{{ $app ? $app->business_phone : '123 123 123' }}">{{ $app ? $app->business_phone : '7579865430' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $app ? $app->business_email : 'tauseed@test.com' }}">{{ $app ? $app->business_email : 'ram@test.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                ...
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker"
                                aria-hidden="true"></i>{{ $app ? $app->address : 'distric Gorakhpur P/O xyz gorakhpur' }}
                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $app ? $app->business_email : 'ram@test.com' }}
                        </p>
                        <p><i class="fa fa-phone"
                                aria-hidden="true"></i>{{ $app ? $app->business_phone : '7579865430' }}</p>
                    </div>
                </div>
                @livewire('subscribe')
            </div>
