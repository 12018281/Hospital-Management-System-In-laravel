...
<div id="home" class="parallax first-section wow fadeIn" data-stellar-background-ratio="0.4" style="background-image:url('images/slider-bg.png');" <?php echo e($app = App\Models\general_settings::latest()->first()); ?>>
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="text-contant">
               <h2>
                  <span class="center"><span class="icon"><img src="<?php echo e(($app) ? config('app.url').'storage/'. $app->icon_logo_path:'images/icon-logo.png'); ?>" alt="#" /></span></span>
...
<div id="about" class="section wow fadeIn">
   <div class="container">
      <div class="heading">
         <span class="icon-logo"><img src="<?php echo e(($app) ? 'storage/'.$app->icon_logo_path:'images/icon-logo.png'); ?>" alt="#"></span>
...
<div id="service" class="services wow fadeIn">
    <div class="container">
       <div class="row">
          ...
          <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('appointmentform')->html();
} elseif ($_instance->childHasBeenRendered('2LWyzeg')) {
    $componentId = $_instance->getRenderedChildComponentId('2LWyzeg');
    $componentTag = $_instance->getRenderedChildComponentTagName('2LWyzeg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2LWyzeg');
} else {
    $response = \Livewire\Livewire::mount('appointmentform');
    $html = $response->html();
    $_instance->logRenderedChild('2LWyzeg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
       </div>
...
} elseif ($_instance->childHasBeenRendered('dIp7tBy')) {
    $componentId = $_instance->getRenderedChildComponentId('dIp7tBy');
    $componentTag = $_instance->getRenderedChildComponentTagName('dIp7tBy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dIp7tBy');
} else {
    $response = \Livewire\Livewire::mount('contactus');
    $html = $response->html();
    $_instance->logRenderedChild('dIp7tBy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\manoj\Downloads\HMS\resources\views/index.blade.php ENDPATH**/ ?>